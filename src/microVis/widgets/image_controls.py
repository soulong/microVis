...
class ImageControls(QScrollArea):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        self._export_channel_combo.setCurrentIndex(1)
        ...
        # Channel filter: all channels vs only checked in channel panel
        self._export_channel_filter = NoScrollComboBox()
        self._export_channel_filter.addItems([
            "All channels",
            "Checked channels",
        ])
        self._export_channel_filter.setCurrentIndex(0)
        self._export_channel_filter.setToolTip(
            "All channels: export all available channels\n"
            "Checked channels: only export channels enabled in the channel panel"
        )
        _row("Ch filter", self._export_channel_filter, export_layout)
    ...
    def get_export_channel_filter(self) -> str:
        """Return the selected channel filter ('All channels' or 'Checked channels')."""
        return self._export_channel_filter.currentText()
    ...
    def set_export_enabled(self, enabled: bool) -> None:
        ...
        self._export_channel_filter.setEnabled(enabled)
